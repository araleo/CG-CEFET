...
void fazquadrado (tipoSprite blocos) //BRUNA: Desenhas os blocos na tela
    {
           ...
           glVertex3f (blocos.posicao.x,blocos.posicao.y,0.0);
           glVertex3f (blocos.posicao.x+blocos.dimensoes.x,blocos.posicao.y,0.0);
           glVertex3f (blocos.posicao.x+blocos.dimensoes.x,blocos.posicao.y+blocos.dimensoes.y,0.0);
           glVertex3f (blocos.posicao.x,blocos.posicao.y+blocos.dimensoes.y,0.0);
           glEnd ();
    } //BRUNA
